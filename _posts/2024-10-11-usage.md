...
![Screenshot](/assets/htb/Screenshot%202024-10-14%20at%2011.42.38.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-11%20at%2016.19.44.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-14%20at%2011.48.37.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-14%20at%2011.49.14.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-14%20at%2011.54.27.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-14%20at%2012.03.18.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-14%20at%2014.04.00.png)
## SQL Injection
![Screenshot](/assets/htb/Screenshot%202024-10-14%20at%2014.08.10.png)

Kết quả SQLmap đã ra như v rồi thì còn nghi ngờ gì nữa mà k attack thẳng luôn ☺️
Thêm các option tools gợi ý và xúc thôi

![Screenshot](/assets/htb/Screenshot%202024-10-14%20at%2014.10.32.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-14%20at%2014.25.45.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-14%20at%2014.56.32.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-14%20at%2015.42.19.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-14%20at%2023.44.28.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2010.00.40.png)

Trời thật không phụ lòng người, cuối cùng cũng crack được pass admin. Login tìm đường RCE thôi nào !!!!

![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2010.02.35.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2010.39.49.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2010.42.57.png)

Khả năng cao là có CVE vì mình nghi đây chưa phải version latest. Google xíu nào.

![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2010.44.02.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2011.06.39.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2011.19.13.png)

Search keyword `version` thì có 3 kết quả.

![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2011.19.52.png)

2 kết quả đầu đã được hiện thị ở dashboard rồi. Vậy còn kết quả thứ 3 là gì nhỉ ?

![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2011.20.47.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2011.41.31.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2011.47.03.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2014.47.09.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2014.49.16.png)

Idea cơ bản nhất là mình sẽ tìm cách lấy key `ssh` vì hồi lúc recon mình nhớ vẫn còn port 22 chưa đụng đến.

![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2014.51.23.png)

Yeah đi vào profile user và thư mục mặc định của ssh là sẽ thấy thôi. (`/home/user/.ssh/`).

![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2014.54.56.png)

Yeah ngol lành, bắt cái thang lên leo thôi.

![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2015.18.22.png)
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2015.18.42.png)
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2015.43.03.png)

Gần như các kỹ thuật leo quyền cơ bản đều không khả dụng trong trường hợp này.

![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2015.28.17.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2015.54.39.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2016.29.09.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2016.42.48.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2016.47.11.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2016.53.58.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2016.55.37.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2017.03.25.png)

Nó là thằng `xander`. Thằng này có dì nhỉ. Lại mò profile nó thôi kkkkk

![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2017.05.20.png)

Mặc dù biết là k được đâu nhưng vẫn cố chấp xem ntn kkkk

![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2017.06.13.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2017.12.55.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-15%20at%2017.18.28.png)
