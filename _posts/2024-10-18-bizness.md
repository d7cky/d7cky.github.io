...
tags:
  ...
  - Linux
  - HTB-Easy
image: '{"path":"/assets/htb/Screenshot%202024-10-18%20at%2010.37.08.png"}'
...
![Screenshot](/assets/htb/Screenshot%202024-10-18%20at%2015.31.13.png)
# Attack
## Recon
### *nmap*
![Screenshot](/assets/htb/Screenshot%202024-10-18%20at%2015.22.16.png)

Khai báo domain `bizness.htb` vào file hosts và truy cập web từ trình duyệt xem có gì húp được hay không.

![Screenshot](/assets/htb/Screenshot%202024-10-18%20at%2015.33.39.png)

Đây có vẻ như là một site quảng bá cho một doanh nghiệp nào đó.
Xem thử nó đang dùng những công nghệ nào ?

![Screenshot](/assets/htb/Screenshot%202024-10-18%20at%2015.34.47.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-18%20at%2016.04.02.png)
...
![Screenshot](/assets/htb/Screenshot%202024-10-18%20at%2016.00.16.png)
...
```
![Screenshot](/assets/htb/Screenshot%202024-10-18%20at%2016.11.18.png)
Bây giờ chạy lại và lấy shell thôi.

![Screenshot](/assets/htb/Screenshot%202024-10-18%20at%2016.12.24.png)

Yeah 🤟🏻🤟🏻🤟🏻 ngon lành.
Flag 1 trong tầm tay.

![Screenshot](/assets/htb/Screenshot%202024-10-18%20at%2016.14.10.png)
## Privilege Escalation
May thay vừa get RCE xong mình đứng ngay path của `ofbiz` luôn.

![Screenshot](/assets/htb/Screenshot%202024-10-18%20at%2017.45.37.png)
