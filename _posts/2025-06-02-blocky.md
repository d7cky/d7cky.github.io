...
tags:
  ...
  - Linux
  - HTB-Easy
permalink: /hackthebox/easy/blocky/
---
# Mô tả
...
![Screenshot](/assets/htb/Screenshot%202025-06-06%20at%2011.42.29.png)
# Attack
## Recon
`nmap`.

![Screenshot](/assets/htb/Screenshot%202025-06-06%20at%2014.41.42.png)

Trong khi chờ đợi mình thử truy cập nó với port 80 trên browser thử.

![Screenshot](/assets/htb/Screenshot%202025-06-06%20at%2011.56.01.png)

Nó tự redirect về blocky.htb => Thế là phải add host cho nó đi rầu.

![Screenshot](/assets/htb/Screenshot%202025-06-06%20at%2017.21.17.png)

Web này có vẻ đang dùng wordpress bản khá cũ. Dùng kỹ thuật list directory xem có gì vui không.

`feroxbuster`

![Screenshot](/assets/htb/Screenshot%202025-06-06%20at%2017.22.20.png)
...
![Screenshot](/assets/htb/Screenshot%202025-06-10%20at%2015.31.56.png)

Yeah hết sảy con bà bảy 👻👻👻. Tìm cách login vào wordpress thôi.

![Screenshot](/assets/htb/Screenshot%202025-06-10%20at%2015.33.18.png)
...
![Screenshot](/assets/htb/Screenshot%202025-06-10%20at%2015.35.37.png)

Đổi nó thành `123` với mã hoá MD5 cho dễ crack rồi go thôi 🥷

![Screenshot](/assets/htb/Screenshot%202025-06-10%20at%2015.38.17.png)
...
![Screenshot](/assets/htb/Screenshot%202025-06-10%20at%2015.45.54.png)

Ề hế lụm kẹo 🤭🤭🤭. Get flag 1 nhanh kẻo lỡ.

![Screenshot](/assets/htb/Screenshot%202025-06-10%20at%2015.47.42.png)
...
![Screenshot](/assets/htb/Screenshot%202025-06-10%20at%2015.52.32.png)

Êhhhhhhhhh, giỡn mà thiệt vậy luôn hả chời 🤣. Thôi xem như trò chơi này trời cho rồi. Lấy flag 2 thôi.

![Screenshot](/assets/htb/Screenshot%202025-06-10%20at%2015.53.51.png)
# Kết luận
## Flag 1
