...
![Screenshot](/assets/htb/Screenshot%202025-06-12%20at%2014.18.57.png)
# Attack
## Recon
`nmap`.

![Screenshot](/assets/htb/Screenshot%202025-06-13%20at%2014.37.05.png)
## GraphQL Attack
...
![Screenshot](/assets/htb/Screenshot%202025-06-13%20at%2014.42.31.png)
![Screenshot](/assets/htb/Screenshot%202025-06-13%20at%2014.43.04.png)
![Screenshot](/assets/htb/Screenshot%202025-06-13%20at%2014.43.28.png)
![Screenshot](/assets/htb/Screenshot%202025-06-13%20at%2014.43.46.png)
...
![Screenshot](/assets/htb/Screenshot%202025-06-13%20at%2014.46.27.png)
...
![Screenshot](/assets/htb/Screenshot%202025-06-13%20at%2015.03.56.png)

Lụm kẹo 😅. Cơ mà pass này là pass đã md5 mất rồi. Dùng `hashcat` crack nó thôi 😚

## Hashcat
![Screenshot](/assets/htb/Screenshot%202025-06-13%20at%2015.09.23.png)

Yeah password được tìm thấy là `godhelpmeplz`
Truy cập vào port 80 và dùng tài khoản vừa tìm được login vào website.

![Screenshot](/assets/htb/Screenshot%202025-06-13%20at%2015.33.18.png)

Ơ kìa 😳. Này là page webservice cơ mà. `feroxbuster` đi fuzz directory thôi.

![Screenshot](/assets/htb/Screenshot%202025-06-13%20at%2015.35.38.png)

À há nó nằm ở `/support`
## Exploit HelpDeskZ 
![Screenshot](/assets/htb/Screenshot%202025-06-13%20at%2015.36.47.png)
...
![Screenshot](/assets/htb/Screenshot%202025-06-13%20at%2015.40.27.png)
### SQLi Attack
...
![Screenshot](/assets/htb/Screenshot%202025-06-13%20at%2015.48.39.png)
...
![Screenshot](/assets/htb/Screenshot%202025-06-16%20at%2011.06.20.png)
...
![Screenshot](/assets/htb/Screenshot%202025-06-16%20at%2011.35.01.png)

_**Trường hợp sai**_

![Screenshot](/assets/htb/Screenshot%202025-06-16%20at%2011.35.51.png)

Dựa vào đây là biết chắc chắn có SQLi rồi. Dùng SQLMap lấy data thôi 😉

![Screenshot](/assets/htb/Screenshot%202025-06-17%20at%2017.33.35.png)

À há có 5 database. Mà ắt hẳn mình chỉ quan tâm đến database `support` thôi.

![Screenshot](/assets/htb/Screenshot%202025-06-17%20at%2017.36.56.png)

Yeah vậy là có 19 table này trong database `support`. Cơ mà table `users` và `staff` có vẻ làm cho mình hứng thú nhất.

![Screenshot](/assets/htb/Screenshot%202025-06-17%20at%2017.42.43.png)

![Screenshot](/assets/htb/Screenshot%202025-06-17%20at%2017.50.02.png)
...
![Screenshot](/assets/htb/Screenshot%202025-06-18%20at%2010.40.06.png)
...
## SSH
![Screenshot](/assets/htb/Screenshot%202025-06-18%20at%2010.42.58.png)
...
![Screenshot](/assets/htb/Screenshot%202025-06-18%20at%2010.45.57.png)
## Privilege Escalation
Như một thói quen leo root mình sẽ `sudo -l` trước 😅.

![Screenshot](/assets/htb/Screenshot%202025-06-18%20at%2010.56.15.png)
...
![Screenshot](/assets/htb/Screenshot%202025-06-18%20at%2010.58.12.png)
...
![Screenshot](/assets/htb/Screenshot%202025-06-18%20at%2011.04.03.png)

Quá đã 😚, lụm flag tiếp theo thôi 😋

![Screenshot](/assets/htb/Screenshot%202025-06-18%20at%2011.05.16.png)
# Kết luận
## Flag 1
```
